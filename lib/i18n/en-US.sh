...
T_CONTINUE="Resume"
T_CONTINUE_IN="Resume — in %s"
T_LIVE="Live"
T_LIVE_RESUMING="resuming in"
T_LIVE_ENTER="press Enter to go back in"
T_RESUME_FOOTER="%d sessions total · Press [R] to see all / search"
T_RESUME_TRUNCATED="%d sessions hidden as burn runs · list truncated — see: clikae resume --all"
T_RESUME_ELSEWHERE="%d more in this store — see: clikae resume (any directory)"
T_BURN_RESUMES_AT="%s burn resumes at %s"
T_TANKS="Tanks"
T_SOLO_SECTION="Solo"
T_LANG_PICK="Interface language"
T_AUTONOMY_PICK="Autonomy on a dry tank"
T_RESUME="resume"
T_ENTER_RESUME="Enter to resume"
T_ALSO_AVAILABLE="Also available"
T_SOUL_NOBRAIN="in the fleet but not sharing the brain: %s  (clikae memory share, or clikae solo to keep it that way)"
...
T_K_OPEN="open"
T_K_RELAY="relay"
T_K_RESUME_ALL="all sessions — search every tank, resume one"
T_K_NEW="new"
T_K_RENAME="rename"
T_K_DELETE="delete"
...
T_CLEAN_SPACE_TO_FREE="Estimated space to move to the Trash: %s"
T_CLEAN_UNCHECKED_HINT="%s row(s) start unchecked — big-but-recent sessions and diverged copies are your call."
T_CLEAN_DRYRUN_NOTE="Dry-run mode: no files were moved."
T_CLEAN_REFUSE_NONINTERACTIVE="Refusing to move anything to the Trash without an interactive confirmation — re-run in a terminal (or use --dry-run to preview)."
T_CLEAN_CANCELLED="Cancelled — nothing moved to the Trash."
T_CLEAN_NOTHING_SELECTED="Nothing selected — nothing moved to the Trash."
T_CLEAN_CONFIRM_Q="Are you sure you want to move these sessions to the Trash?"
T_CLEAN_CONFIRM_PROMPT="Press Enter to proceed, or Ctrl-C to cancel: "
T_CLEAN_NO_CONFIRM="No confirmation received — nothing moved to the Trash."
T_CLEAN_DELETING="Moving session files to the Trash..."
T_CLEAN_DONE="Cleanup complete. Moved approximately %s to the Trash — empty the Trash to actually free that space."
T_CLEAN_TRASH_UNAVAILABLE="Couldn't move to the Trash — left where it is: %s"
T_CLEAN_SKIPPED_N="%d item(s) were left in place. Nothing was deleted."
T_CLEAN_TRASH_UNUSABLE="The Trash isn't usable, so nothing was touched."
T_CLEAN_TRASH_UNUSABLE_HINT="clikae clean only ever MOVES sessions to ~/.Trash — it never deletes them. Fix or empty ~/.Trash and run it again."
...
T_CLEAN_PICKER_HINT="· ↑↓ move · space toggle · a all · ⏎ move selected to Trash · q cancel"
T_CLEAN_TALLY="selected: %s of %s · %s to Trash"
...
# `clikae clean` archive-marker guard (the "is it backed up yet" fourth guard)
T_CLEAN_ARCHIVE_WITHHELD="%s session(s) not offered: written after the last archive run (%s)."
T_CLEAN_ARCHIVE_ABSENT="No archive marker found (%s) — nothing offered for session data. Use --no-archive-check to override."
T_CLEAN_ARCHIVE_REASON_MISSING="no marker file yet"
T_CLEAN_ARCHIVE_REASON_UNREADABLE="the marker file can't be read"
T_CLEAN_ARCHIVE_REASON_NONNUMERIC="the marker isn't a valid timestamp"
T_CLEAN_ARCHIVE_REASON_FUTURE="the marker's timestamp is in the future"
T_K_HELP="help"
T_K_LANG="language"
...
T_ENGINES_HERE="%s engines, here:"
T_ENGINES_SUPPORTED="%s engines supported"
