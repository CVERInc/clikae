...
T_SOUL_NOBRAIN="在船队里却没有共享大脑：%s （clikae memory share 加入，或 clikae solo 让它正式独立）"
...
T_CLEAN_TRASH_UNAVAILABLE="无法移到废纸篓 — 原地保留：%s"
T_CLEAN_SKIPPED_N="有 %d 个项目原地保留，没有删除任何东西。"
T_CLEAN_TRASH_UNUSABLE="废纸篓无法使用，因此什么都没有改动。"
