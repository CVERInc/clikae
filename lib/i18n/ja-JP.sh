...
T_CLEAN_SPACE_TO_FREE="解放できる容量の目安: %s"
T_CLEAN_UNCHECKED_HINT="%s 件が未チェック — 大きいが最近のセッションと分岐コピーはあなたの判断で。"
T_CLEAN_DRYRUN_NOTE="ドライラン: ファイルは削除されていません。"
T_CLEAN_REFUSE_NONINTERACTIVE="対話的な確認なしでは削除しません — ターミナルで再実行するか、--dry-run でプレビューしてください。"
T_CLEAN_CANCELLED="キャンセルしました — 何も削除していません。"
T_CLEAN_NOTHING_SELECTED="選択なし — 何も削除していません。"
T_CLEAN_CONFIRM_Q="これらのセッションを完全に削除してよろしいですか?"
T_CLEAN_CONFIRM_PROMPT="Enter で続行、Ctrl-C でキャンセル: "
T_CLEAN_NO_CONFIRM="確認が得られませんでした — 何も削除していません。"
T_CLEAN_DELETING="セッションファイルを削除中..."
T_CLEAN_DONE="整理が完了しました。約 %s を解放しました。"
...
T_CLEAN_PICKER_HINT="· ↑↓ 移動 · space 切替 · a 全選択 · ⏎ 削除実行 · q 中止"
T_CLEAN_TALLY="選択: %s / %s 件 · 解放 %s"
