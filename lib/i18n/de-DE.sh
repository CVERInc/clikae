...
T_CLEAN_TRASH_UNAVAILABLE="Konnte nicht in den Papierkorb verschoben werden — bleibt liegen: %s"
T_CLEAN_SKIPPED_N="%d Objekt(e) blieben liegen. Es wurde nichts gelöscht."
T_CLEAN_TRASH_UNUSABLE="Der Papierkorb ist nicht nutzbar, daher wurde nichts angefasst."
T_CLEAN_TRASH_UNUSABLE_HINT="clikae clean VERSCHIEBT Sitzungen nur nach ~/.Trash — löschen tut es nie. Repariere oder leere ~/.Trash und starte es erneut."
