...
T_CLEAN_SPACE_TO_FREE="Geschätzter freizugebender Speicherplatz: %s"
...
T_CLEAN_REFUSE_NONINTERACTIVE="Löschen ohne interaktive Bestätigung verweigert — führe den Befehl in einem Terminal erneut aus (oder nutze --dry-run zur Vorschau)."
...
T_CLEAN_TALLY="ausgewählt: %s von %s · %s freizugeben"
