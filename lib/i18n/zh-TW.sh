...
T_CLEAN_SPACE_TO_FREE="預估可釋放空間：%s"
T_CLEAN_UNCHECKED_HINT="%s 列預設未勾選 — 大但新的 session 與分歧副本，由你決定。"
T_CLEAN_DRYRUN_NOTE="Dry-run 模式：未刪除任何檔案。"
T_CLEAN_REFUSE_NONINTERACTIVE="沒有互動式確認就不刪除 — 請在終端機重新執行，或用 --dry-run 預覽。"
T_CLEAN_CANCELLED="已取消 — 未刪除任何內容。"
T_CLEAN_NOTHING_SELECTED="未選取任何項目 — 未刪除任何內容。"
T_CLEAN_CONFIRM_Q="確定要永久刪除這些 session 嗎？"
T_CLEAN_CONFIRM_PROMPT="按 Enter 繼續，或 Ctrl-C 取消："
T_CLEAN_NO_CONFIRM="未收到確認 — 未刪除任何內容。"
T_CLEAN_DELETING="刪除 session 檔案中…"
T_CLEAN_DONE="清理完成，已釋放約 %s。"
...
T_CLEAN_PICKER_HINT="· ↑↓ 移動 · space 勾選 · a 全選 · ⏎ 刪除已選 · q 取消"
T_CLEAN_TALLY="已選 %s／%s · 釋放 %s"
