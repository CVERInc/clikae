...
T_CLEAN_SPACE_TO_FREE="Espace estimé à libérer : %s"
T_CLEAN_UNCHECKED_HINT="%s ligne(s) démarrent décochées — grosses mais récentes, et copies divergentes : à vous de voir."
T_CLEAN_DRYRUN_NOTE="Mode dry-run : aucun fichier supprimé."
T_CLEAN_REFUSE_NONINTERACTIVE="Pas de suppression sans confirmation interactive — relancez dans un terminal (ou utilisez --dry-run pour prévisualiser)."
T_CLEAN_CANCELLED="Annulé — rien n'a été supprimé."
T_CLEAN_NOTHING_SELECTED="Rien sélectionné — rien n'a été supprimé."
T_CLEAN_CONFIRM_Q="Voulez-vous vraiment supprimer ces sessions définitivement ?"
T_CLEAN_CONFIRM_PROMPT="Appuyez sur Enter pour continuer, ou Ctrl-C pour annuler : "
T_CLEAN_NO_CONFIRM="Aucune confirmation reçue — rien n'a été supprimé."
T_CLEAN_DELETING="Suppression des fichiers de session..."
T_CLEAN_DONE="Nettoyage terminé. Environ %s libérés."
...
T_CLEAN_PICKER_HINT="· ↑↓ déplacer · space cocher · a tout · ⏎ supprimer la sélection · q annuler"
T_CLEAN_TALLY="sélectionné : %s sur %s · %s à libérer"
