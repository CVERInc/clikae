...
T_CLEAN_NONE_MINSIZE="Aucune session d'au moins %s MB trouvée (0 fichier à nettoyer)."
T_CLEAN_NONE_AGE_MINSIZE="Aucune session de plus de %s jours et d'au moins %s MB trouvée (0 fichier à nettoyer)."
T_CLEAN_NONE_ALL="Rien à nettoyer — pas de copies redondantes, pas de session de plus de %s jours, aucune de plus de %s MB."
...
T_CLEAN_ERR_MIN_SIZE="Erreur : --min-size nécessite un nombre de megabytes."
