...
T_CLEAN_TRASH_UNAVAILABLE="Impossible de mettre à la corbeille — laissé en place : %s"
T_CLEAN_SKIPPED_N="%d élément(s) laissés en place. Rien n'a été supprimé."
T_CLEAN_TRASH_UNUSABLE="La corbeille est inutilisable, rien n'a donc été touché."
