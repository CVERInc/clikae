---
title: Memory (Soul)
description: Share one vendor-neutral markdown brain across your tanks and engines; what stays isolated, and clikae solo.
section: Reference
order: 2
---
...
> drifts** (it's literally the same file). Design rationale: [`grammar.md` §10](grammar).
...
Full roadmap: the maintainer's plan + [`grammar.md` §10](grammar).
