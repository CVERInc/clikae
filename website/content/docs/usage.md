---
title: Usage
description: The clikae verb, tanks, engines, and the home board.
...
of the language is in [grammar.md](grammar).
...
lines of bash — see [adding-an-adapter.md](adding-an-adapter).
